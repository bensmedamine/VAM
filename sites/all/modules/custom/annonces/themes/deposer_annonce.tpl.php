...
<?php if (!user_is_logged_in()): ?>
  ...
  <p class="fs-12"><span class="blue">&rarr;</span> <strong>Vous n’avez pas encore un compte ?</strong><br /> veuillez vous inscrire en seulement 2 minutes en suivant ce <a href="/inscription" title="Inscription">lien</a>.</p>
